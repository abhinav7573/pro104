...
def get_mean(total_weight,total_enteries):
    mean=total_weight/total_enteries
    print(f"mean is {mean:2f}")

def get_median(total_enteries,sorted_data):
    if total_enteries %2==0:
        median1= float(sorted_data[total_enteries//2])
        median2= float(sorted_data[total_enteries//2-1])
        median= (median1+median2)/2
    else:
        median=float(sorted_data[total_enteries//2])
